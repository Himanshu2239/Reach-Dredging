...
//     date: "",
//     dredger: "Select dredger type", // default selected option
//     shift: "Select shift",
//     forward: "",
//     width: "",
//     depth: "",
...
//     e.preventDefault();
//     console.log("Submitted Survey Work Log Data:", formData);
//     // Add submission logic (e.g., API calls) as needed
//   };
...
const SurveyWorkLogReport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5000/survey/addSurveyData", {
        method: "POST",
        headers: {
