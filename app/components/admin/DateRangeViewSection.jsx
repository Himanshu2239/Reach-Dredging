...
export default function DateRangeViewSection({
  ...
  return (
    // <div className="flex flex-col md:flex-row text-sm md:text-xl justify-between items-center mb-6 bg-white p-4 rounded-lg shadow w-full">
    //   <div className="w-full md:w-auto mb-4 md:mb-0">
    //     {/* Date input */}
    //     <label className="mr-2 md:font-semibold">Date:</label>
    //     <input
    //       type="date"
